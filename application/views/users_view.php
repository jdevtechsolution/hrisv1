                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        <button class="btn"  id="btn_new" style="width:185px;font-family: Tahoma, Georgia, Serif;background-color:#2ecc71;color:white;margin-top:10px;margin-left:17px;" title="Create New Leave" >
