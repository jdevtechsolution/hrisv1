                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        <button class="btn"  id="btn_new" style="width:300px;font-family: Tahoma, Georgia, Serif;background-color:#2ecc71;color:white;margin-top:10px;margin-left:17px;" title="Create New Disciplinary Action Policy" >
    ...
    var initializeControls=function(){
        dt=$('#tbl_employee_list').DataTable({
            ...
            "columns": [
                ...
                { targets:[1],data: "disciplinary_action_policy" },
