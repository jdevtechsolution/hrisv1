                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        <button class="btn"  id="btn_new" style="width:220px;font-family: Tahoma, Georgia, Serif;background-color:#2ecc71;color:white;margin-top:10px;margin-left:17px;" title="Create New Position" >
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    ...
                                    <input type="text" class="form-control" id="pay_period_sequence" name="pay_period_sequence" placeholder="Period" required>
                                </div>
                              </div>
                            </div><br>
                            <div class="row">
        ...
        dt=$('#tbl_payperiod_list').DataTable({
            ...
            "columns": [
            	...
            	},
                {
                    targets:[5],
                    render: function (data, type, full, meta){
                        var btn_edit='<button class="btn btn-default btn-sm" name="edit_info" searchPlaceholder  data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i> </button>';
