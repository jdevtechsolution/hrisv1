                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        <button class="btn"  id="btn_new" style="width:230px;font-family: Tahoma, Georgia, Serif;background-color:#2ecc71;color:white;margin-top:10px;margin-left:17px;" title="Create New SSS Contribution" >
                                    ...
                                    <div class="panel-body table-responsive" style="padding-top:8px;">
                                        <table id="tbl_sss_contribution_list" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                            	<tr>
                                            		<th colspan="2" style="background-color:#41a5f5;color:#FFF;"><center>Range of Compensation</center></th>
                                            		<th colspan="1">&nbsp;</th>
                                            		<th colspan="4" style="background-color:#f66156;color:#FFF;"><center>Social Security</center></th>
                                            		<th colspan="3">&nbsp;</th>
                                            	</tr>
                                                <tr>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    ...
                                    <label class="boldlabel">Monthly Salary Credit :</label>
                                    ...
                                    <label class="boldlabel">Employer's Contribution :</label>
